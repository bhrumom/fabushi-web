...
export function getFaliuMeritBenefits(work: string | null | undefined, juan: string | number | null | undefined) {
  ...
  if (normalizedWork === "T0246" && normalizedJuan === "2") {
    return T0246_JUAN_2_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0247" && normalizedJuan === "1") {
    return T0247_JUAN_1_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0248" && normalizedJuan === "1") {
    return T0248_JUAN_1_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0249" && normalizedJuan === "1") {
    return T0249_JUAN_1_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0250" && normalizedJuan === "1") {
    return T0250_JUAN_1_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0251" && normalizedJuan === "1") {
    return T0251_JUAN_1_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0252" && normalizedJuan === "1") {
    return T0252_JUAN_1_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0253" && normalizedJuan === "1") {
    return T0253_JUAN_1_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0254" && normalizedJuan === "1") {
    return T0254_JUAN_1_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0255" && normalizedJuan === "1") {
    return T0255_JUAN_1_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0256" && normalizedJuan === "1") {
    return T0256_JUAN_1_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0257" && normalizedJuan === "1") {
    return T0257_JUAN_1_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0258" && normalizedJuan === "1") {
    return T0258_JUAN_1_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0259" && normalizedJuan === "1") {
    return T0259_JUAN_1_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0260" && normalizedJuan === "1") {
    return T0260_JUAN_1_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0260" && normalizedJuan === "2") {
    return T0260_JUAN_2_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0260" && normalizedJuan === "3") {
    return T0260_JUAN_3_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0260" && normalizedJuan === "4") {
    return T0260_JUAN_4_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0261" && normalizedJuan === "1") {
    return T0261_JUAN_1_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0261" && normalizedJuan === "2") {
    return T0261_JUAN_2_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0261" && normalizedJuan === "3") {
    return T0261_JUAN_3_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0261" && normalizedJuan === "4") {
    return T0261_JUAN_4_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0261" && normalizedJuan === "5") {
    return T0261_JUAN_5_MERIT_BENEFITS;
  }

  if (normalizedWork === "T0261" && normalizedJuan === "6") {
    return T0261_JUAN_6_MERIT_BENEFITS;
  }
